...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "5ca5e254-bde5-4c10-b06d-501b6ea711ac");
  ...
  return (
    <motion.div
     initial= {{opacity:0, x:-200}}
       ...
       viewport={{once: true}} className='text-center p-6 py-20 lg:px32
     w-full overflow-hidden' id='Contact'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center '>Contact <span className='underline underline-offset-4 under decoration-1 font-light'>with Us</span></h1>
